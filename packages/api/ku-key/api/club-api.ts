...
export const getclubClubIdDeletePath = (clubId: number) => {
  return `/club/{clubId}`.replace(`{${'clubId'}}`, encodeURIComponent(String(clubId)))
}
export const getclubClubIdPatchPath = (
  clubId: number,
  name?: string,
  category?: string,
  summary?: string,
...
export const getclubHotGetPath = () => {
  return `/club/hot`
}
export const getclubLikeClubIdPostPath = (clubId: number) => {
  return `/club/like/{clubId}`.replace(`{${'clubId'}}`, encodeURIComponent(String(clubId)))
}
export const getclubPostPath = (
  name: string,
  category: string,
  summary: string,
  regularMeeting: string,
...
export const getclubRecommendGetPath = (isLogin: boolean) => {
  return `/club/recommend`
}
