...
export const getcourseAcademicFoundationGetPath = (
  year: string,
  semester: string,
  college: string,
  cursorId?: number,
) => {
  return `/course/academic-foundation`
}
export const getcourseCourseIdGetPath = (courseId: number) => {
  return `/course/{courseId}`.replace(`{${'courseId'}}`, encodeURIComponent(String(courseId)))
}
export const getcourseGeneralGetPath = (year: string, semester: string, cursorId?: number) => {
  return `/course/general`
}
export const getcourseMajorGetPath = (year: string, semester: string, major: string, cursorId?: number) => {
  return `/course/major`
}
export const getcourseSearchAcademicFoundationGetPath = (
  college: string,
  keyword: string,
  year: string,
  semester: string,
  ...
  return `/course/search-academic-foundation`
}
export const getcourseSearchAllGetPath = (keyword: string, year: string, semester: string, cursorId?: number) => {
  return `/course/search-all`
}
export const getcourseSearchCourseCodeGetPath = (
  courseCode: string,
  year: string,
  semester: string,
  cursorId?: number,
) => {
  return `/course/search-course-code`
}
export const getcourseSearchGeneralCourseNameGetPath = (
  courseName: string,
  year: string,
  semester: string,
  cursorId?: number,
) => {
  return `/course/search-general-course-name`
}
export const getcourseSearchGeneralGetPath = (keyword: string, year: string, semester: string, cursorId?: number) => {
  return `/course/search-general`
}
export const getcourseSearchGeneralProfessorNameGetPath = (
  professorName: string,
  year: string,
  semester: string,
  cursorId?: number,
) => {
  return `/course/search-general-professor-name`
}
export const getcourseSearchMajorCourseNameGetPath = (
  major: string,
  courseName: string,
  year: string,
  semester: string,
  ...
  return `/course/search-major-course-name`
}
export const getcourseSearchMajorGetPath = (
  major: string,
  keyword: string,
  year: string,
  semester: string,
  ...
  return `/course/search-major`
}
export const getcourseSearchMajorProfessorNameGetPath = (
  major: string,
  professorName: string,
  year: string,
  semester: string,
  ...
  return `/course/search-major-professor-name`
}
