...
export const gettimetableColorTimetableIdPatchPath = (
  timetableId: number,
  updateTimetableColorDto: UpdateTimetableColorDto,
) => {
  return `/timetable/color/{timetableId}`.replace(`{${'timetableId'}}`, encodeURIComponent(String(timetableId)))
}
export const gettimetableCourseDeletePath = (timetableId: number, courseId: number) => {
  return `/timetable/course`
}
export const gettimetableCoursePostPath = (timetableId: number, courseId: number) => {
  return `/timetable/course`
}
export const gettimetableMainTimetableGetPath = (semester: string, year: string) => {
  return `/timetable/main-timetable`
}
export const gettimetableNameTimetableIdPatchPath = (
  timetableId: number,
  updateTimetableNameDto: UpdateTimetableNameDto,
) => {
  return `/timetable/name/{timetableId}`.replace(`{${'timetableId'}}`, encodeURIComponent(String(timetableId)))
}
export const gettimetablePostPath = (createTimetableDto: CreateTimetableDto) => {
  return `/timetable`
}
export const gettimetableTimetableIdDeletePath = (timetableId: number) => {
  return `/timetable/{timetableId}`.replace(`{${'timetableId'}}`, encodeURIComponent(String(timetableId)))
}
export const gettimetableTimetableIdGetPath = (timetableId: number) => {
  return `/timetable/{timetableId}`.replace(`{${'timetableId'}}`, encodeURIComponent(String(timetableId)))
}
export const gettimetableTimetableIdPatchPath = (timetableId: number, timetableDto: TimetableDto) => {
  return `/timetable/{timetableId}`.replace(`{${'timetableId'}}`, encodeURIComponent(String(timetableId)))
}
export const gettimetableUserGetPath = () => {
